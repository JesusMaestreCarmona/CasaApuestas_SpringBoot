package com.casaApuestas.jwtSecurity;
...
public class MyWebFilter implements Filter{
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
    	...
    	if (metodoRequerido.equalsIgnoreCase("OPTIONS") || // Si se recibe una petición options, se deja pasar por el filtro
    			...
    			uriDePeticionWeb.equals("/tipoSexo/all") || // Web de recuperarUsuarioAutenticado, aunque no traiga JWT en la cabecera se le permite pasar
    			uriDePeticionWeb.equals("/usuario/buscarEmail") || // Web de recuperarUsuarioAutenticado, aunque no traiga JWT en la cabecera se le permite pasar
